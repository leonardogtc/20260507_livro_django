# Generated by Django 6.0.5 on 2026-05-13 15:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='address',
            name='day_week',
            field=models.ManyToManyField(blank=True, related_name='DayWeek', to='medicSearch.dayweek'),
        ),
        migrations.CreateModel(
            name='Neighborhood',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='City', to='medicSearch.city')),
            ],
        ),
        migrations.AddField(
            model_name='address',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Avaliou', to=settings.AUTH_USER_MODEL)),
                ('user_rated', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Avaliado', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='profile',
